...
private:
  ...
  std::shared_ptr<BondInquiryServiceConnector> publishCon;
public:

  BondInquiryService( std::shared_ptr<BondInquirySericeConnector> publishCon_):publishCon(publishCon_)
  {
  ...
  virtual void OnMessage(Inquiry<Bond> &data)
  {
    ...
    publishCon->Publish(BondInquiryMP[inquiryId]);
  }
...
{
private:
  std::shared_ptr< BondInquiryService > inquiryService;
public:

  BondInquiryServiceConnector(std::shared_ptr<BondInquiryService> inquiryService_):inquiryService(inquiryService_){};
    ...
    while(getline(file,line))
  {
        ...
        if(!inquiryId.empty())
        {
          if(productId = "2Y")
          {
            ...
            Inquriy<Bond> obj = Inquiry<Bond>(inquiryId,bond2Y,pside,quantity,quote,pstate);
          ...
          else if(productId = "3Y")
          {
            ...
            Inquriy<Bond> obj = Inquiry<Bond>(inquiryId,bond3Y,pside,quantity,quote,pstate);
            inquiryService->OnMessage(obj);
          ...
          else if (productId = "5Y")
          {
            ...
            Inquriy<Bond> obj = Inquiry<Bond>(inquiryId,bond5Y,pside,quantity,quote,pstate);
            inquiryService->OnMessage(obj);
          }
          else if(productId = "7Y")
          {
            ...
            Inquriy<Bond> obj = Inquiry<Bond>(inquiryId,bond7Y,pside,quantity,quote,pstate);
            inquiryService->OnMessage(obj);
          ...
          else if(productId = "10Y")
          {
            ...
            Inquriy<Bond> obj = Inquiry<Bond>(inquiryId,bond10Y,pside,quantity,quote,pstate);
            inquiryService->OnMessage(obj);
          ...
          else if(productId = "30Y")
          {
            ...
            Inquriy<Bond> obj = Inquiry<Bond>(inquiryId,bond30Y,pside,quantity,quote,pstate);
            inquiryService->OnMessage(obj);
          }
         }
      } 
...
private:
  std::shared_ptr<BondInquiryService> BondInquiryService;

public:

  BondInquiryServiceListener(std::shared_ptr<BondInquiryService> BondInquiryService_):BondInquiryService(BondInquiryService_){};
  ...
  virtual void ProcessAdd(Inquiry<Bond> &data)
  {
      ...
      {
        BondInquiryService->SendQuote(inquiryId,100);  
      }
